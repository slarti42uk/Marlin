...
#define STRING_CONFIG_H_AUTHOR "(Steve Kingsley)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //#define DEFAULT_Kd 105.53

  // E3dv6 with PT100 (Taken from Prusa Firmware)
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 53.33, 80, 640.00, 418.6 }
